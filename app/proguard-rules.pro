...
-keep public class * extends gold.android.videoplayer.base.adapter.widget.BaseViewHolder
-keepclassmembers  class **$** extends gold.android.videoplayer.base.adapter.widget.BaseViewHolder {
     <init>(...);
}
